...
if(isset($_POST['btn-signup'])){
  ...
  try {
    ...
    $patient_name = $userRow['first_name']." ". $userRow['middle_name'];
    $conn = new PDO("mysql:host=localhost;dbname=clinic", "root", "");
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    $stmt = conn->prepare("INSERT INTO orders (specialization,doctor,date,patient_name)
        VALUES(:specialization,:doctor,:date,:patient_name)");
...
<form action="" method="post">
  ...
  <div class="row">
    <div class="col-md-3"><h4>Spetsalisation: </h4></div>
    <div class="col-md-5">
  ...
  <div class="row">
    <div class="col-md-3"><h4>Doctor: </h4></div>
    <div class="col-md-5">
 ...
 <button class="btn btn-info" name="submit"> Book </button>
  </div>
  </div>
